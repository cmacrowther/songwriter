...
export const SongDataTemplate = (props) => {
  ...
  const song_count =
    song_ids.length > 10 ? song_ids.length : number_words[song_ids.length]
  //get track data
  ...
  if (songs_call) {
    ...
    songs_call.tracks.forEach((track) =>
      track.artists.forEach((artist) =>
        !doesContain(artists_ids, artist.id)
  ...
  if (songs) {
    posts.forEach(({ node: post }) => {
      songs.tracks.forEach((track, index) => {
        if (
          post.frontmatter.url.split('track/').pop().split('?')[0] ===
            track.id &&
          post.frontmatter.songurl
        ) {
        ...
        <div className="container">
          <div className="columns is-desktop">
                      ...
                      <tbody>
                        <tr className="album-row">
                          <td className="album-column">
                            <div
                              className={`album level is-mobile media ${
                                current_song === songs?.tracks[0].preview_url &&
                                songs?.tracks[0].preview_url != null
                                  ? 'is-playing'
                                  : ''
                              }`}
                            >
                              <div className="album-content level-left">
                                <div className="media-left">
                                  {songs?.tracks[0].preview_url ? (
                                    <button
                                      className="album-art image ml-0 mr-0 is-96x96"
                                      onClick={() =>
                                        setCurrentSong(
                                          songs?.tracks[0].preview_url
                                        )
                                    ...
                                    >
                                      <img
                                        alt={songs?.tracks[0].name}
                                        src={
                                          songs?.tracks[0].album.images[0].url
                                        }
                                      />
                                ...
                                <div className="media-content">
                                  <p className="title has-text-weight-bold mb-5 is-6 is-6 is-size-6-mobile">
                                    <a
                                      className="song-link"
                                      href={
                                  ...
                                  <p className="subtitle has-text-grey is-6 is-6 is-size-6-mobile">
                                    <a
                                      className="song-link"
                                      href={
                                        songs?.tracks[0].artists[0]
                                          .external_urls.spotify
                                      }
                                    >
                                      {songs?.tracks[0].artists[0].name}
                                    </a>
                                  </p>
                                  {current_song ===
                                    songs?.tracks[0].preview_url &&
                ...
                <div className="block mt-5 pt-3">
                  <div className="field is-grouped">
                    <div className="control">
                      <button
                        className="button is-mobile is-success has-text-weight-bold is-rounded"
                        onClick={() => setCounter(counter + itemsPerPage)}
                      >
                        Show More
                      </button>
                    </div>
            ...
            <div className="column m-4 is-one-thirds-desktop">
                ...
                {artists?.artists.map(function (artist, index) {
                  return (
                    <a
                      ...
                      className="collaborator media mb-0 mt-0 is-borderless is-mobile level"
                    >
                      <div className="level-left">
                        ...
                        <div className="media-content">
                          <p className="title has-text-weight-bold is-6 has-text-dark">
                            {artist.name}
                          </p>
                        </div>
                      </div>
              ...
              <div className="block mt-5 pt-3">
                <div className="field is-grouped">
                  <div className="control">
                    <a
                      href={props.playlist}
                      className="button is-success has-text-weight-bold is-mobile is-rounded"
                    >
                      Listen on Spotify
                    </a>
                  </div>
                  <div className="control">
                    <a href={'mailto:' + props.email}>
                      <button className="button has-text-weight-bold is-rounded">
                        Contact
                      </button>
                    </a>
                  </div>
              ...
              <div className="block mt-5 pt-3">
                <p className="title has-text-weight-bold is-size-6 pb-1">
                  This page is managed by {props.managed}
                </p>
