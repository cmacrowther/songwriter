          ...
          <div className="container has-background-black has-text-white-ter">
            <div className="columns footer-column pb-5">
              <div className="column m-4 is-8-touch is-12-mobile">
                <p className="has-text-weight-light has-text-grey-light is-size-6">Powered by <a className="project-link" href="//gitlab.com/cmacrowther/songwriter">Songwriter<FontAwesomeIcon className="pl-1" size="sm" icon={brands('js')} /></a></p>
              </div>
